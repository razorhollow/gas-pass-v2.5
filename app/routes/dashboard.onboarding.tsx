  ...
  return (
    <Form method="post">
      <div>
        ...
        <Input ref={firstNameRef} type="text" name="firstName" required />
      ...
      <div>
        <span>Last Name: </span>
        <Input ref={lastNameRef} type="text" name="lastName" required />
      ...
      <div>
        ...
        <Input ref={employeeIdRef} type="text" name="employeeId" required />
